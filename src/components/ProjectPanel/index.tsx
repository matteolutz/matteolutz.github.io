...
const ProjectPanel: FC<IProjectPanelProps> = ({project}) => {
    ...
    return (
        <div className="project-panel" onClick={openProject}>
            ...
            <p className="project-panel__description">
                {project.description || <span className="project-panel__no-desc">[ No description available ]</span>}
            </p>
            <p className="project-panel__stars"><FaStar/> <span>{project.stargazers_count}</span></p>
        </div>
    )
};
